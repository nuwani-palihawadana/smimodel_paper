...
Further examples include @Ho2020, who used semi-parametric additive models to estimate ground-level $\text{PM}_{2.5}$ concentrations in Taiwan, while nonparametric additive models were utilised by @Ibrahim2021 for predicting census survey response rates. @Ravindra2019 provided a comprehensive review of the applications of additive models in environmental data, with a special focus on air pollution, climate change, and human health related studies.
