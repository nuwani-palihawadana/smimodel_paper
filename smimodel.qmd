...
The form of $f$ is typically nonlinear, and involves complicated interactions with a high value of $p$. Consequently, the estimation of $f$ involves many ad hoc model choices. It is essentially impossible to estimate a general $p$-dimensional function for large $p$ due to the curse of dimensionality [@Bellman57; @Stone82]. Instead, we normally impose some form of additivity, along with some low-order interactions.
