...
The characteristics and the performance of the proposed algorithm based on each of these initialisation option, vary depending on the nature of the application. Some initial experimental insights regarding the same will be discussed in more detail in @sec-simulation. 
