...
-   $g_{j}, j = 1, \dots, p$, $f_{1}$ and $f_{2}$ are unknown nonparametric functions;
...
The variables temperature, dew point, wind, rain and humidity were considered to be the main set of predictors in the model. The daily solar intensity is plotted against each of these predictors in @fig-preds.

<!-- The daily solar intensity is plotted against each of these predictors in @fig-preds, @fig-Tmin, and @fig-Vp respectively, where we can observe that the relationships between all these predictors and the response are slightly non-linear. -->
