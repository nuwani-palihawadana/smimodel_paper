...
lagged values of \(y_{t}\) along with the lagged predictors, the model
is able to capture the serial correlation that is present in the data.
...
to diverse application problems, there are several unresolved issues in
