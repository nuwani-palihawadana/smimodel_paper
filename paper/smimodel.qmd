...
4. **Multiple: Picking One From Multiple Initialisations**
    ...
    \todo[inline]{The last method needs more details. Do you use methods 1--3 and choose the best?}
...
\todo[inline]{Didn't we decide to use the same training data for all models?}
...
\todo[inline]{Explain notation SMI Model (a,b)}
