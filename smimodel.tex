...
the best forecasting accuracy. Next, a nonparametric additive model with
backward elimination for predictor selection as proposed by
\textcite{FH2012}, and the CGAIM proposed by \textcite{Masselot2022},
are also presented for comparison purposes. In the case of CGAIM,
following \textcite{Masselot2022}, maximum temperature lags, minimum
temperature lags and vapor pressure lags are categorised into three
groups, where we estimated an index for each of those groups using the
CGAIM algorithm. Furthermore, the index coefficients of the CGAIM were
