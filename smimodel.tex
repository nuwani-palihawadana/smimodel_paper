...
% Authors
  ...
  \addresses{%
   ...
   \lfoot{\sf Palihawadana, Hyndman, Wang: 14 May 2024}
...
penalty parameter tuning of the SMI model. Here, once the tuning for the
two penalty parameters is completed, the model is re-fitted for the
entire data set combining training and validation sets. The data of year
