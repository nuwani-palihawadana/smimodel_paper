...
are kept a side as the test set for evaluating the forecasting error of
...
``Multiple'' options, we are using the default values of the required
parameters as stated in Section~\ref{sec-step1}. (We used \(M = 10\), a
convergence tolerance of \(0.001\) and \(50\) maximum iterations in step
3.3 (Section~\ref{sec-step3_3}), and a convergence tolerance for
coefficients of \(0.001\) in step 3.5 (Section~\ref{sec-step3_5}) in
estimating all SMI Models.)

\hypertarget{sec-sim-results}{%
\subsection{Results}\label{sec-sim-results}}

We summarise the results of the simulation experiment explained above in
